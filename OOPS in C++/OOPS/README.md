...
<img alt="class" src="./ClassesImg.jpg" />

Classes have objects which have the same data type as defined in the class.

## Constructors in C++

<img alt="constructor" src="./constructorImg.jpg" />
...
<img alt="copy-constructor" src="./CopyConstructorImg.jpg" />
